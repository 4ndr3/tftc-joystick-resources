...
- [Thrustmaster_Warthog_Layout_v1.0.fcf](./warthog/profile-1/Thrustmaster_Warthog_Layout_v1.0.fcf)
- [Thrustmaster_Warthog_Layout_v1.0.pdf](./warthog/profile-1/Thrustmaster_Warthog_Layout_v1.0.pdf)

---

## :material-cog: Profile 2 (TWCS)
This profile (xml) uses a Joystick Gremlin configuration file.  It maps the Thrustmaster Warthog and Thrustmaster TWCS controllers for X-Wing Alliance / Tie Fighter.

### Files

- [TieFighterWarthog-and-TWCS-Gremlin-profile.xml](./warthog/profile-2/TieFighterWarthog-and-TWCS-Gremlin-profile.xml) - the actual profile to be loaded.
